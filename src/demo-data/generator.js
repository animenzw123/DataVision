...
export const globalSalesValues = {
  ...
  shipped: [true, false],
  regoNum: ({ random }) => Math.random().toString(36).slice(2),
  asset: [
    "13T Excavator",
    "36T Excavator",
    "24T Excavator",
  ...
  year: ["2020", "2018", "2016", "2012", "2010", "2008", "2007", "2006"],
  taskNames: [
    "Excavator Operator",
    "Drainage Crew Truck & Tools",
    "Dozer Operator",
    "Dry Hire",
    "RDO",
    "Rained Off",
  ],
  ABN: ({ random }) => Math.random().toString().slice(2, 11),
  id: ({ random }) => Math.random().toString().slice(2, 11),
};
